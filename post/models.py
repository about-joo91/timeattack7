...
class JobPostActivity(models.Model):
    ...
    job_post_status = models.ForeignKey('JobPostStatus', on_delete=models.SET_NULL, null=True)
    class Meta:
...
class RecruitActivity(models.Model):
    job_post_activity = models.OneToOneField('JobPostActivity', on_delete=models.CASCADE)
    status = models.ForeignKey('RecruitStatus', on_delete=models.SET_NULL, null=True)